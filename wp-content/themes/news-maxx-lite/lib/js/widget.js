...
function kopa_shortcode_icon_click(shortcode, textarea){
    ...
    switch(shortcode){
        ...
        case 'dropcaps':
            ...
            break;
        case 'button':
            textarea.insertAtCaret('[button color="e.g. dark, grey" size="e.g. small, medium, big" link="" target="e.g. _self, _blank"]Button','[/button]');
            break;
        case 'alert':
            textarea.insertAtCaret('[alert type="e.g. warning, danger, success, info"]', '[/alert]');
            break;
        case 'tabs':
            var tabs_string = '[tabs]';
            tabs_string += ' [tab title="Tab 1"]Tab content 1[/tab]';
            tabs_string += ' [tab title="Tab 2"]Tab content 2[/tab]';
            tabs_string += ' [tab title="Tab 3"]Tab content 3[/tab]';
            tabs_string += ' [/tabs]';
        ...
        case 'contact_form':
            ...
            break;
        // case 'posts_lastest':
        //     textarea.insertAtCaret('[posts count="10" orderby="lastest" cats="" tags="" relation="OR" style="e.g. number, images"][/posts]','');
        //     break;
        // case 'posts_popular':
        //     textarea.insertAtCaret('[posts count="10" orderby="popular" cats="" tags="" relation="OR" style="e.g. number, images"][/posts]','');
        //     break;
        // case 'posts_most_comment':
        //     textarea.insertAtCaret('[posts count="10" orderby="most_comment" cats="" tags="" relation="OR" style="e.g. number, images"][/posts]','');
        //     break;
        // case 'posts_random':
        //     textarea.insertAtCaret('[posts count="10" orderby="random" cats="" tags="" relation="OR" style="e.g. number, images"][/posts]','');
        //     break;
        case 'youtube':
